...
export const Cell = ({
  ...
  const classes = classnames(
    ...
    {
      'bg-white dark:bg-black border-lightgray dark:border-darkgray':
        !status,
      'border-black dark:border-gray': value && !status,
      ...
      'correct shadowed bg-green text-white border-green':
        status === 'correct' && !isHighContrast,
      'present shadowed bg-yellow text-white border-yellow':
        status === 'present' && !isHighContrast,
